...
class Bot(BaseBot):
    """
    wystawia ofertę (pierwsza oferta np 0.01) - kierunek BEAR
    Sprawdza w te "ostatnie 10 sekund " tak jak teraz ale ma tylko jeden kierunek zawsze BEAR
    jak wygra to stawia 0.01 - kierunek BEAR
    jak przegra to stawia x2 - kierunek BEAR
    """
    already_bet = False
    multiplier = 1
    last_bet = None
